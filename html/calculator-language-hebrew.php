                                    ...
                                    <tr>
                                        <td class="GemTableValue" id="TableValue_Hebrew_Standard">
                                            <font style="color: RGB(255, 227, 93);">
                                                <div class="NumberClass"><b id="finalBreakNum" class="justnumber" onclick="javascript:Open_Properties(0)">0</b></div>
                                            </font>
                                        </td>
                ...
                <div id="ChartSpot">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td id="cipherChartTitle" colspan="11"><span id="moveCipherUp" class="moveCipher" onclick="javascript:MoveCipher(undefined, 1)"><i class="fas fa-chevron-circle-up"></i></span>
                                    <font style="color: RGB(255, 227, 93)">Hebrew Standard</font> <span id="moveCipherDown" class="moveCipher" onclick="javascript:MoveCipher(undefined, 2)"><i class="fas fa-chevron-circle-down"></i></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
