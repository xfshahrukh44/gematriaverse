                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('nostalgia-calculators-nextgen')}}"><img decoding="async" src="images/NextGenCalc.png" width="300px"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('nostalgia-calculators-date')}}"><img decoding="async" src="images/NextGenDates.png" width="300px"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('nostalgia-calculators-classic')}}"><img decoding="async" src="images/ClassicCalc.png" width="300px"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('nostalgia-calculators-basic')}}"><img decoding="async" src="images/BasicCalc.png" width="300px"></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
