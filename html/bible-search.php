...
<script src="js/bibletool.js"></script>
                ...
                <div class="main-content-area full-width-template">
                    ...
                    <div class="page-content clearfix">
                        <div class="wpb-content-wrapper">
                            <div id="wbc-66f5bfca473d3" class="vc_row wpb_row  full-width-section" style="padding-top: 60px;padding-bottom: 30px;">
                                <div class="container">
                                    <div class="-inner">
                                        <div class="wpb_column vc_column_container vc_col-sm-12 text-center">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="current-user">Username: <span class="user-name">Mersdecodes</span><br>User ID: <span class="user-id">9727</span><br>Membership level: <span class="membership-level">Enthusiast</span></div>
                                                    <div class="tool-wrapper">
                                                        <link rel="stylesheet" type="text/css" href="tools/bible-search/css/bibletool.css">
                                                        ...
                                                        <div class="container-bible">
                                                            ...
                                                            <div id="firstRow" class="row">
                                                                <div id="bookSelect" class="col-xs-12 col-lg-6">
                                                                    <h3 class="mo-only" onclick="myFunction(this), directSearchShow()"><span> + </span>Direct Search</h3>
                                                                    <h3 class="no-mo">Direct Search</h3>
                                                                    <div id="directSearchSection">
                                                                        <div id="bookSelector">
                                                                            <label>Book</label>
                                                                            <br>
                                                                            <select id="SelectBook" onchange="javascript:Change_Selection(0), hide(this)">
                                                                                <option value="Any Book">Any Book</option>
                                                                        ...
                                                                        <div id="chapterSelector">
                                                                            <label>Chapter</label>
                                                                            <br>
                                                                            <select class="form-select form-select-sm" id="SelectChapter" onchange="javascript:Change_Selection(1)">
                                                                        ...
                                                                        <div id="verseSelector">
                                                                            <label>Verse</label>
                                                                            <br>
                                                                            <select class="form-select form-select-sm" id="SelectVerse">
                                                                                <option value="All">All</option>
                                                                                <option value="1">1</option>
                                                                                <option value="2">2</option>
                                                                                <option value="3">3</option>
                                                                        ...
                                                                        <button class="buttonFunction" type="button" id="BibleSearchButton" onclick="SearchByBook()" value="Add Date">SEARCH</button>
                                                                ...
                                                                <div id="gemSelect" class="col-xs-12 col-lg-6">
                                                                    <h3 class="mo-only" onclick="myFunction2(this), phraseValueSearchShow()"><span> + </span>Phrase/Value Search</h3>
                                                                    <h3 class="no-mo">Phrase/Value Search</h3>
                                                                    <div id="phraseValueSearchSection">
                                                                        <label>Enter Word, Phrase, or Number</label>
                                                                        <br>
                                                                        <input id="wordPhraseNumber" oninput="Confirm_Same()" class="form-control form-control-sm" type="text" tabindex="1">
                                                                        <script>
                                                                        ...
                                                                        <!--</ul>-->
                                                                        <button id="WPNSearchButton" class="buttonFunction" onclick="SearchByNumber()" value="SearchNumber">SEARCH</button>
                                                                        <br>
                                                                        <input tabindex="4" type="checkbox" id="Match_Any" value="Match Any" title="If multiple items are being searched, ANY match will populate in the list below." onclick="Change_Options(0)" checked=""><span title="If multiple items are being searched, ANY match will populate in the list below."> Match Any</span>
                                                                        <input tabindex="5" type="checkbox" id="Match_All" value="Match All" title="If multiple items are being searched, ALL matches MUST be present to render a result in the list below." onclick="Change_Options(1)"><span title="If multiple items are being searched, ALL matches MUST be present to render a result in the list below."> Match All</span>
                                                                        <input tabindex="3" type="checkbox" id="Include_Verses" value="Verses" title="Includes the Verse name in the Gematria calculation.
					...
					instead of just the verse 'In the beginning God created the heaven and the earth.'"> Include Verse Name</span>
                                                            ...
                                                            <div id="secondRow" class="row">
                                                                <div class="col-xs-12 col-lg-6">
                                                                    <h3 class="mo-only" onclick="myFunction3(this), verseNumberSearchShow()"><span> + </span>Verse Number Search</h3>
                                                                    <h3 class="no-mo">Verse Number Search</h3>
                                                                    <div id="verseNumberSearchSection">
                                                                        <label>Enter Verse Number</label>
                                                                        <br>
                                                                        <input id="verseNumber" class="form-control form-control-sm" type="number" tabindex="1">
                                                                        <script>
                                                                        ...
                                                                        <button id="verseSearchButton" class="buttonFunction" onclick="SearchByVerseNumber()" value="Search Verse Number">SEARCH</button>
                                                                        <div class="mo-only"><br>
                                                                            <script>
                                                                ...
                                                                <div id="options" class="col-xs-12 col-lg-6">
                                                                    <h3 class="mo-only" onclick="myFunction4(this), optionsShow()"><span> + </span>Options</h3>
                                                                    <h3 class="no-mo">Options</h3>
                                                                    <div id="optionsSection">
                                                                        <button class="buttonFunction width150"><a id="ciphModBtn" onclick="javascript:Open_Ciphers()" data-fancybox="ciphers" data-src="#ciphMod">Ciphers</a></button>
                                                                        <!-- CIPHER MODAL -->
                                                                        <div id="ciphMod" class="ciphMod">
                                                                            ...
                                                                            <center>
                                                                                ...
                                                                                <br>
                                                                                <br>
                                                                                <button class="buttonFunctionCiphers" id="CancelCiphers" onclick="javascript:Cancel_Ciphers()">Return</button>
                                                                                <br>
                                                                                <br>
							...
							<span>Select previous Preset to load: <select name="LoadPresets" id="PresetDropdown2"></select> <button class="buttonFunctionCiphers" id="LoadCiphers" onclick="javascript:Load_Preset()">Load</button><br><br>
                                                                        ...
                                                                        <!-- END CIPHER MODAL -->
                                                                        <button id="bookDatBtn" class="buttonFunction width150"><a class="verLink" data-fancybox="bookdata" data-src="#bookDatMod" onclick="javascript:BuildBookTable()">BOOK DATA</a></button>
                                                                        <!-- The Book Data Modal -->
                                                            ...
                                                            <div id="resultsContainer" class="row">
                                                                <center>
                                                                    <div id="DropHere" class="col-xs-12">31 results for Book 'Genesis: Chapter 1' found<table id="MainTable" class="table">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>Verse</th>
                                                                                    <th>Ordinal</th>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:1')">Genesis 1:1</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:2')">Genesis 1:2</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:3')">Genesis 1:3</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:4')">Genesis 1:4</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:5')">Genesis 1:5</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:6')">Genesis 1:6</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:7')">Genesis 1:7</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:8')">Genesis 1:8</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:9')">Genesis 1:9</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:10')">Genesis 1:10</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:11')">Genesis 1:11</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:12')">Genesis 1:12</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:13')">Genesis 1:13</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:14')">Genesis 1:14</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:15')">Genesis 1:15</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:16')">Genesis 1:16</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:17')">Genesis 1:17</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:18')">Genesis 1:18</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:19')">Genesis 1:19</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:20')">Genesis 1:20</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:21')">Genesis 1:21</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:22')">Genesis 1:22</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:23')">Genesis 1:23</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:24')">Genesis 1:24</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:25')">Genesis 1:25</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:26')">Genesis 1:26</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:27')">Genesis 1:27</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:28')">Genesis 1:28</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:29')">Genesis 1:29</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:30')">Genesis 1:30</a></td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><a class="verLink" href="javascript:OpenDetails('Genesis_1:31')">Genesis 1:31</a></td>
                                                                                    <td>
