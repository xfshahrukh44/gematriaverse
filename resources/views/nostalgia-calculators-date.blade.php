...
@section('title', 'Date nostalgia calculator')

@section('css')
    <link rel="stylesheet" type="text/css" href="{{asset('css/DateDurations-201.css')}}">
@endsection
...
@section('js')
    <script src="{{asset('js/DateCalc-207.js')}}"></script>
@endsection
