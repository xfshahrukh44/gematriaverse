...
{{--                                </span>--}}
                                <div id="Date1Inputs" class="row">
                                    ...
                                    <div class="mdyDiv">
                                        Day:<br>
                                        <input tabindex="2" type="number" max="31" min="1" class="u_Inp"
                                            id="Day1" value="<?php echo date('d', strtotime($previousDate)); ?>">
                                    </div>
                                    <div class="mdyDiv">
                                        Year:<br>
                                        <input tabindex="3" type="number" max="9999" min="0" class="u_Inp"
                                            id="Year1" value="<?php echo $previousYear; ?>">
                                    </div>
                                </div>
                                <center>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="javascript:NavEclipse(1, 1)"
                                                        ...
                                                        href="javascript:NavEclipse(2, 1)" class="eclipseNextPrev">Last</a>
                                                </td>
                                                ...
                                                <td class="SignCell" id="SignSpot1">
                                                    <font>
                                                        <div class="SignDropdown">
                                                            ...
                                                            <div id="SignDropdown0" class="SignDropdown-content"><span
                                                ...
                                                <td class="SignCell" id="SignSpot2">
                                                    <font>
                                                        <div class="SignDropdown">
                                                            ...
                                                            <div id="SignDropdown1" class="SignDropdown-content"><span
                                                                    class="astrologyLabel">Symbol:</span>
                                                                <span class="astrologyInfo">Scales</span><br><span
                                                                    class="astrologyLabel">Element:</span>
                                                                <span class="astrologyInfo">Air</span><br><span
